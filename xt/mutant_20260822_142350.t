...
# Source:  # Fire _open() first so $self->{'berkeley'} is known before we parse @_.
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  return set_return($self->_scan_berkeley($params), { type => 'arrayref' });
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  Accepts the same criteria and C<join> parameter as L</selectall_arrayref>.
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  Deprecated alias for L</selectall_array>.  Use C<selectall_array> in new
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  # The former lazy .+? could scan past the first ) in pathological SQL;
# Hint:    Likely missing edge-case test (boundary value)
# Mutations on this line (1 variant):
#   Numeric boundary flip == to !=
TODO: {
...
# Source:  lookup.  The method name is the column you want; the arguments are criteria.
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# Source:  $self->_trace(__LINE__, ": AUTOLOAD $key: return '$rc' from slurped data");
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  # Single pass instead of three (map→grep→map): avoids three
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  # Scan the entire BerkeleyDB tied hash, building rows as {entry=>$k, value=>$v},
# Hint:    Likely missing edge-case test (boundary value)
# Mutations on this line (1 variant):
#   Numeric boundary flip == to !=
TODO: {
...
# Source:  Carp::croak(ref($self), ': BerkeleyDB does not support JOINs');
# Hint:    Likely missing edge-case test (boundary value)
...
# --- SURVIVOR: BOOL_NEGATE_2533_3 (MEDIUM) line 2533 in _match_criterion() ---
# Source:  sub _match_criterion
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_2533_3 line 2533 in _match_criterion()';
    # NOTE: new() called with no arguments as a starting point.
    # If Database::Abstraction requires constructor arguments, add them here.
    my $obj = new_ok('Database::Abstraction');
    # TODO: exercise line 2533 in _match_criterion() to detect the mutant
...
# --- LOW HINT: RETURN_UNDEF_2533_3 line 2533 in _match_criterion() ---
# Source:  sub _match_criterion
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
